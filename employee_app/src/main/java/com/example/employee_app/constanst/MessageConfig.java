...
public class MessageConfig {
    ...
    public static final String DEPARTMENT_STATUISMISSING ="Department Status is mssing  ";
    public static final String DEPARTMENT_STATUS_NOT_PROPER ="Department Status between true or false";
    public static final String DEPARTMENT_ALREADY_EXIST  ="Defartment already exits .";
