...
public class MessageConfig {
    ...
    public static final String EMPLOYEE_ALREADY_DELETED = "Employee already deleted please check ."; ///checjk
    //Department
    ...
    public static final String DEPARTMENT_MISSED_MATCHED_WITH_DESIGNATION_DEPARTMENT_ID = "Please check this specific designation is not allotted to department id ";
    ...
    public static final String DESIGNATION_NAME_DUPLICATE = "Designation name is already present ,please enter different name .for this department id please check ";
    ...
    public static final String IMAGE_DATA_TYPE_NOT_PROPER = "Please upload the image of jpg or jpeg  format";
